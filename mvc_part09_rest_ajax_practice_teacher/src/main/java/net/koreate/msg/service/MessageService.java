...
public interface MessageService {
	 ...
	 *             sender : 발신자 id <br>
	 *             message : 전달할 메세지 <br>
	 *             message 정보를 table에 추가 한 후 발신한 사용자(sender)의 upoint를 10점 부여
	 */
	 ...
	 * @return 
	 * 		   수신된 메세지 정보(opendate 확인 시간 포함) 수신확인 시간으로 
	 * 		   tbl_message 행 정보 수정 후 수정 <br>
	 *         완료된 메세지 정보를 반환 <br>
	 *         수신확인한 사용자의 upoint 정보를 5점 부여 <br>
	 */
	MessageVO readMessage(String userid, int mno) throws Exception;
